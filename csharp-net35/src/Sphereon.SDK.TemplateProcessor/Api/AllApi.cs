...
namespace Sphereon.SDK.TemplateProcessor.Api
{
    ...
    public partial class AllApi : IAllApi
    {
        ...
        public ApiResponse< byte[] > GetResultStreamWithHttpInfo (string jobId, ResultStreamRequest resultStreamRequest)
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
                throw new ApiException(400, "Missing required parameter 'jobId' when calling AllApi->GetResultStream");
            // verify the required parameter 'resultStreamRequest' is set
            if (resultStreamRequest == null)
                throw new ApiException(400, "Missing required parameter 'resultStreamRequest' when calling AllApi->GetResultStream");
