...
public interface MergeApi {
  ...
  @POST("template-processor/merge/0.1/datasets")
  ...
  @POST("template-processor/merge/0.1/templates")
  ...
  @DELETE("template-processor/merge/0.1/datasets/{dataSetId}")
  ...
  @DELETE("template-processor/merge/0.1/jobs/{jobId}")
  ...
  @DELETE("template-processor/merge/0.1/templates/{templateId}")
  ...
  @GET("template-processor/merge/0.1/jobs/{jobId}")
  ...
  @GET("template-processor/merge/0.1/jobs")
  ...
  @PUT("template-processor/merge/0.1/jobs/{jobId}/result/file/{streamId}")
  ...
  @GET("template-processor/merge/0.1/templates/{templateId}")
  ...
  @PUT("template-processor/merge/0.1/jobs")
  ...
  @PUT("template-processor/merge/0.1/templates")
  Call<TemplateContextResponse> updateTemplateContext(
    @retrofit2.http.Body TemplateContextRequest templateContextRequest
  );
  ...
  @POST("template-processor/merge/0.1/templates/{templateId}")
