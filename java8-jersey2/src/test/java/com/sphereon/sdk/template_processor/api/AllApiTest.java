...
public class AllApiTest {
    ...
    public void createTemplateContextTest() throws ApiException {
        api.getApiClient().setAccessToken("d03991a8-76f0-31d1-a444-e8a47e8fa5a4");
        TemplateContextRequest templateRequest = new TemplateContextRequest();
        templateRequest.setTemplateType(TemplateContextRequest.TemplateTypeEnum.FREEMARKER);
        templateRequest.setDescription("Test");
        templateRequest.setTemplateId("123ABC");
        TemplateContextResponse response = api.createTemplateContext(templateRequest);
        api.deleteTemplateContext("123ABC");
