...
public class MergeJob {
  ...
  **/
   ...
   * @return jobId
  **/
  @ApiModelProperty(required = true, value = "The server generated job jobId. This jobId is checked against the jobId in the request path on every invocation")
  ...
  **/
  @ApiModelProperty(required = true, value = "The storage locations of the result files.")
  ...
  **/
  @ApiModelProperty(value = "Header data set ids")
