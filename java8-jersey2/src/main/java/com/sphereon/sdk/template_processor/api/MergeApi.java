...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-08-17T15:33:23.033+02:00")
public class MergeApi {
  ...
  public DataSetResponse createDataSet(String payload) throws ApiException {
    ...
    String localVarPath = "/template-processor/merge/0.1/datasets".replaceAll("\\{format\\}","json");
  ...
  public TemplateContextResponse createTemplateContext(TemplateContextRequest templateRequest) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/templates".replaceAll("\\{format\\}","json");
  ...
  public DataSetResponse deleteDataSet(String dataSetId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/datasets/{dataSetId}".replaceAll("\\{format\\}","json")
  ...
  public MergeJobResponse deleteJob(String jobId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/jobs/{jobId}".replaceAll("\\{format\\}","json")
  ...
  public TemplateContextResponse deleteTemplateContext(String templateId) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/templates/{templateId}".replaceAll("\\{format\\}","json")
  ...
  public List<MergeJobResponse> getJobs(List<String> status) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/jobs".replaceAll("\\{format\\}","json");
  ...
  public byte[] getResultStreamById(String jobId, String streamId, OutputSettings outputSettings) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/jobs/{jobId}/result/file/{streamId}".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "jobId" + "\\}", apiClient.escapeString(jobId.toString()))
  ...
  public byte[] getResultStreamsAsContainer(String jobId, OutputSettings outputSettings) throws ApiException {
    ...
    // create path and map variables
    String localVarPath = "/template-processor/merge/0.1/jobs/{jobId}/result/container".replaceAll("\\{format\\}","json")
      .replaceAll("\\{" + "jobId" + "\\}", apiClient.escapeString(jobId.toString()));
  ...
  public TemplateContextResponse updateTemplateContext(TemplateContextRequest templateContextRequest) throws ApiException {
    ...
    if (templateContextRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'templateContextRequest' when calling updateTemplateContext");
    }
