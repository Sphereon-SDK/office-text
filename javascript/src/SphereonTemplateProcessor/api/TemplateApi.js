...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonTemplateProcessor/ApiClient', 'SphereonTemplateProcessor/model/TemplateContextResponse', 'SphereonTemplateProcessor/model/TemplateContextRequest', 'SphereonTemplateProcessor/model/ErrorResponse', 'SphereonTemplateProcessor/model/TemplateContext'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/TemplateContextResponse'), require('../model/TemplateContextRequest'), require('../model/ErrorResponse'), require('../model/TemplateContext'));
  } else {
    // Browser globals (root is window)
    if (!root.TemplateProcessor) {
      root.TemplateProcessor = {};
    }
    root.TemplateProcessor.TemplateApi = factory(root.TemplateProcessor.ApiClient, root.TemplateProcessor.TemplateContextResponse, root.TemplateProcessor.TemplateContextRequest, root.TemplateProcessor.ErrorResponse, root.TemplateProcessor.TemplateContext);
  }
}(this, function(ApiClient, TemplateContextResponse, TemplateContextRequest, ErrorResponse, TemplateContext) {
  'use strict';
