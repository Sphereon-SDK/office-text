...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonTemplateProcessor/ApiClient', 'SphereonTemplateProcessor/model/ErrorResponse', 'SphereonTemplateProcessor/model/MergeJobResponse', 'SphereonTemplateProcessor/model/MergeSettings', 'SphereonTemplateProcessor/model/OutputSettings', 'SphereonTemplateProcessor/model/ResultStreamRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorResponse'), require('../model/MergeJobResponse'), require('../model/MergeSettings'), require('../model/OutputSettings'), require('../model/ResultStreamRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.TemplateProcessor) {
      root.TemplateProcessor = {};
    }
    root.TemplateProcessor.JobApi = factory(root.TemplateProcessor.ApiClient, root.TemplateProcessor.ErrorResponse, root.TemplateProcessor.MergeJobResponse, root.TemplateProcessor.MergeSettings, root.TemplateProcessor.OutputSettings, root.TemplateProcessor.ResultStreamRequest);
  }
}(this, function(ApiClient, ErrorResponse, MergeJobResponse, MergeSettings, OutputSettings, ResultStreamRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:SphereonTemplateProcessor/api/JobApi~getResultStreamCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:SphereonTemplateProcessor/api/JobApi~getResultStreamCallback} callback The callback function, accepting three arguments: error, data, response
