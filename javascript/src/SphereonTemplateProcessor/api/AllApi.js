...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['SphereonTemplateProcessor/ApiClient', 'SphereonTemplateProcessor/model/DataSetResponse', 'SphereonTemplateProcessor/model/ErrorResponse', 'SphereonTemplateProcessor/model/TemplateContextResponse', 'SphereonTemplateProcessor/model/TemplateContextRequest', 'SphereonTemplateProcessor/model/MergeJobResponse', 'SphereonTemplateProcessor/model/OutputSettings', 'SphereonTemplateProcessor/model/MergeSettings', 'SphereonTemplateProcessor/model/TemplateContext'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DataSetResponse'), require('../model/ErrorResponse'), require('../model/TemplateContextResponse'), require('../model/TemplateContextRequest'), require('../model/MergeJobResponse'), require('../model/OutputSettings'), require('../model/MergeSettings'), require('../model/TemplateContext'));
  } else {
    // Browser globals (root is window)
    if (!root.TemplateProcessor) {
      root.TemplateProcessor = {};
    }
    root.TemplateProcessor.AllApi = factory(root.TemplateProcessor.ApiClient, root.TemplateProcessor.DataSetResponse, root.TemplateProcessor.ErrorResponse, root.TemplateProcessor.TemplateContextResponse, root.TemplateProcessor.TemplateContextRequest, root.TemplateProcessor.MergeJobResponse, root.TemplateProcessor.OutputSettings, root.TemplateProcessor.MergeSettings, root.TemplateProcessor.TemplateContext);
  }
}(this, function(ApiClient, DataSetResponse, ErrorResponse, TemplateContextResponse, TemplateContextRequest, MergeJobResponse, OutputSettings, MergeSettings, TemplateContext) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:SphereonTemplateProcessor/api/AllApi~getResultStreamByIdCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:SphereonTemplateProcessor/api/AllApi~getResultStreamByIdCallback} callback The callback function, accepting three arguments: error, data, response
    ...
    this.updateTemplateContext = function(templateContext, callback) {
      ...
      if (templateContext == undefined || templateContext == null) {
        throw "Missing the required parameter 'templateContext' when calling updateTemplateContext";
      }
