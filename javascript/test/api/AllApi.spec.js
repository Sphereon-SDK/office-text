...
(function(root, factory) {
  ...
  describe('AllApi', function() {
    ...
    describe('getResultStream', function() {
      it('should call getResultStream successfully', function(done) {
        //uncomment below and update the code to test getResultStream
        //instance.getResultStream(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getResultStreamsAsContainer', function() {
      it('should call getResultStreamsAsContainer successfully', function(done) {
        ...
        //instance.getResultStreamsAsContainer(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
