...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TemplateProcessor.MergeJobResponse();
  });
  ...
  describe('MergeJobResponse', function() {
    it('should create an instance of MergeJobResponse', function() {
      ...
      //var instane = new TemplateProcessor.MergeJobResponse();
      //expect(instance).to.be.a(TemplateProcessor.MergeJobResponse);
    });
