...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OfficeTextMerge.MergeJobResponse();
  });
  ...
  describe('MergeJobResponse', function() {
    it('should create an instance of MergeJobResponse', function() {
      // uncomment below and update the code to test MergeJobResponse
      //var instane = new OfficeTextMerge.MergeJobResponse();
      //expect(instance).to.be.a(OfficeTextMerge.MergeJobResponse);
    });
