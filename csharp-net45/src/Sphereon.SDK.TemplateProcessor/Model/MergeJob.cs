...
namespace Sphereon.SDK.TemplateProcessor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MergeJob :  IEquatable<MergeJob>, IValidatableObject
    {
        /// <summary>
        ...
        public MergeJob(string JobId = default(string), string DataSetId = default(string), List<StreamLocation> ResultStreams = default(List<StreamLocation>), List<string> HeaderDataSetIds = default(List<string>), StorageLocation ResultStorageLocation = default(StorageLocation), MergeSettings MergeSettings = default(MergeSettings))
        {
