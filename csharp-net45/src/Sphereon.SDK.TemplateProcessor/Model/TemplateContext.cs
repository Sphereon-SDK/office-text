...
namespace Sphereon.SDK.TemplateProcessor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateContext :  IEquatable<TemplateContext>, IValidatableObject
    {
        /// <summary>
        ...
        public TemplateContext(TemplateTypeEnum? TemplateType = default(TemplateTypeEnum?), Dictionary<string, StreamLocation> TemplateFileLocations = default(Dictionary<string, StreamLocation>), string Description = default(string), OwnerInfo OwnerInfo = default(OwnerInfo), StorageLocation StorageLocation = default(StorageLocation), string Id = default(string), string TemplateId = default(string))
        {
