...
namespace Sphereon.SDK.TemplateProcessor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutputSettings :  IEquatable<OutputSettings>, IValidatableObject
    {
        /// <summary>
        ...
        public OutputSettings(DeliveryFormatEnum? DeliveryFormat = default(DeliveryFormatEnum?), OutputFormatEnum? OutputFormat = default(OutputFormatEnum?))
        {
