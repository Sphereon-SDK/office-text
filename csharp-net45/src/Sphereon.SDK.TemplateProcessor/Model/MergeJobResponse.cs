...
namespace Sphereon.SDK.TemplateProcessor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MergeJobResponse :  IEquatable<MergeJobResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public MergeJobResponse(string JobId = default(string), MergeJob Job = default(MergeJob))
        {
