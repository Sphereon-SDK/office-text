...
namespace Sphereon.SDK.TemplateProcessor.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TemplateContextResponse :  IEquatable<TemplateContextResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public TemplateContextResponse(TemplateContext Context = default(TemplateContext), string Id = default(string))
        {
